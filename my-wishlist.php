...
<html lang="es">
	<head>
	    ...
	    <title>Mi lista de recetas favoritos</title>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">mi lista de recetas favoritos</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<tr>
					<td class="col-md-2"><a href="product-details.php?pid=<?php echo htmlentities($pd=$row['pid']);?>"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="200" height="200"></a></td>
					<td class="col-md-6">
...
?>
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Agregar al recetario</a>
					</td>
