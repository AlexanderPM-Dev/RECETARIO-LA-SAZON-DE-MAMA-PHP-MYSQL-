		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Nombre de receta</th>
					...
					<th class="cart-description item">Fecha de receta consultada</th>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="#">
						    <img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="122" height="146">
						</a>
					</td>
