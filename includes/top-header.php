...
<?php if(strlen($_SESSION['login']))
    {   ?>
				...
				<?php } ?>
					...
					<li><a href="#"><i class="fa fa-2x fa-home"></i> Pagina principal</a></li>
					<li><a href="my-account.php"><i class="icon fa fa-user"></i>Mi cuenta</a></li>
					<li><a href="my-wishlist.php"><i class="icon fa fa-heart"></i>Lista de recetas favoritas</a></li>
					<li><a href="my-cart.php"><i class="icon fa fa-shopping-cart"></i>Mis recetas guardadas</a></li>
...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="track-orders.php" class="dropdown-toggle" ><span class="key">Historial de recetas</b></a>
