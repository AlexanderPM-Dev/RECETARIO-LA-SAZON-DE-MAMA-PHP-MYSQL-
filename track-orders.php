...
<div class="body-content outer-top-bd">
	<div class="container">
		<div class="track-order-page inner-bottom-sm">
			<div class="row">
				<div class="col-md-12">
	<h2>Seguimiento de sus recetas</h2>
	<span class="title-tag inner-top-vs">
Ingrese su código/número de pedido en el cuadro a continuación y presione ENTER. Se le envío en su correo electrónico de confirmación que debería haber recibido. </span>
