...
echo "<script>alert('No se registro  algo salió mal');</script>";
}
}
// Code for User login
...
<html lang="es">
	<head>
	    ...
	    <title>La sazon de mama | Signi-in | Signup</title>
...
<div class="form-group">
	...
	<div class="checkbox">
	  	<label class="checkbox">
		  	Rapidez y seguridad en tu forma de proporcionar tus datos.
		</label>
		<label class="checkbox">
		Seguimiento de pedidos de recetas.
		</label>
		<label class="checkbox">
			Revisa tu Historial de busqueda de recetas.
		</label>
	</div>
</div>	
