...
{?>							
	...
	<div class="product">		
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-primary" type="button">Agregar a lista de recetas</button></a>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>No se encontraron resultados</h3>
		</div>
