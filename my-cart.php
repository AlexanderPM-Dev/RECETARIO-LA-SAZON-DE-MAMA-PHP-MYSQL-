	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Lista de recetas guardadas</li>
			</ul>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">Receta imagen</th>
					<th class="cart-product-name item">Ranking de calificaciones</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continuar consulta</a>
								<input type="submit" name="submit" value="Actualizar lista de recetas" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="204" height="146">
						</a>
					</td>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Claificaciones )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	...
	<?php } else {
echo "Tu lista de recetas esta vacía";
		}?>
</div>	
		</div>
		</div> 
