...
echo "<script>alert('Producto incluido en la lista de favoritos');</script>";
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">LAS MEJORES RECETAS</h3>
...
?>    
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="210" height="210" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<!-- <div class="product-price">	
							    ...
							    <span class="price-before-discount">S/.<?php echo htmlentities($rws['productPriceBeforeDiscount']);?></span>					
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary" style="height:34px;padding-top: 5px;">Agregar a la lista de recetas</a>
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="380" height="380" />
                </a>
            </div>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Lista de favoritos" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
											   Agregar a favoritos <i class="fa fa-heart"></i>
											</a>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/Los-delfines-de-Mari-105717658384207/" target="_blank"></a></li>
						                <li><a class="fa fa-twitter" href="https://www.facebook.com/Los-delfines-de-Mari-105717658384207/"target="_blank"></a></li>
						                <li><a class="fa fa-linkedin" href="https://twitter.com/home?lang=es" target="_blank"></a></li>
						                <li><a class="fa fa-rss" href="https://www.facebook.com/Los-delfines-de-Mari-105717658384207/" target="_blank"></a></li>
						                <li><a class="fa fa-pinterest" href="https://www.facebook.com/Los-delfines-de-Mari-105717658384207/" target="_blank"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Comentarios de Usuarios</h4>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="ingrese su nombre..." name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Resumen <span class="astk">*</span></label>
																	<input type="text" class="form-control txt" id="exampleInputSummary" placeholder="ingrese su resumen..." name="summary" required="required">
																</div><!-- /.form-group -->
															</div>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="Escribenos tus comentarios..." name="review" required="required"></textarea>
																</div><!-- /.form-group -->
															</div>
														</div><!-- /.row -->
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Recetas similares </h3>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="170" height="170" alt=""></a>
			</div><!-- /.image -->			
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Agregar al recetario</a>
